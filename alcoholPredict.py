...
def show_predict_page():
    st.title("Aocohol Consumption Prediction")
    ...
    grades = st.slider("Grades", 0,3000,70)
    ...
    if okButton:
        ...
        st.text('The result range from 0 to 9, a higher number indicates a higher alcohol consumption')
